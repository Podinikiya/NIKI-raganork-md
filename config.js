...
if (!(process.env.SESSION || process.env.SESSION_ID)"Raganork~b28ee3452d153374ad92abcbf5017119:384e3473345738633543733d";
module.exports = {
    VERSION: 'v4.0.0',
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '94774574323-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~b28ee3452d153374ad92abcbf5017119:384e3473345738633543733d').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'NIKIYA',
    ...
    MODE: process.env.MODE || 'group/inbxe',
